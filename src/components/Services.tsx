...
export default function Services() {
  ...
  return (
    <section id="services" className="py-24 sm:py-32 bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-72 h-72 bg-emerald-100/30 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
          ...
          {services.map((service, i) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-white rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-emerald-200"
              >
